...
// functions/3-z-complete.ts
__export(exports, {
  handler: () => handler
});
var import_airtable_node = __toModule(require_src());
var import_dotenv = __toModule(require_main());
import_dotenv.default.config();
var airtable = new import_airtable_node.default({ apiKey: process.env.AIRTABLE_API_KEY }).base(process.env.AIRTABLE_APP_BASE).table("products");
...
//# sourceMappingURL=3-z-complete.js.map
